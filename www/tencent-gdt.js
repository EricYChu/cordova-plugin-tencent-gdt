...
SplashAd.show = function(slotId) {
  ...
  exec(cb, cb, 'TencentGDT', 'showSplashAd', [options]);
  return ad;
};
...
RewardedVideoAd.show = function(slotId, userId) {
  ...
  exec(cb, cb, 'TencentGDT', 'showRewardedVideoAd', [options]);
  return ad;
};
...
InterstitialAd.show = function(slotId, width, height) {
  ...
  exec(cb, cb, 'TencentGDT', 'showInterstitialAd', [options]);
  return ad;
};
...
BannerAd.show = function(slotId, width, height, align, interval) {
  ...
  exec(cb, cb, 'TencentGDT', 'showBannerAd', [options]);
  return ad;
};
...
BannerAd.hide = function(slotId) {
  ...
  exec(cb, cb, 'TencentGDT', 'hideBannerAd', [options]);
  return ad;
};
